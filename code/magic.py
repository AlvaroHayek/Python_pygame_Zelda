...
class MagicPlayer:
    def __init__(self,animation_player):
        ...
        self.sounds = {
        'heal': pygame.mixer.Sound('../graphics/NinjaAdventure/Audio/Sounds/Magic & Skill/Heal.wav'),
        'flame': pygame.mixer.Sound('../graphics/NinjaAdventure/Audio/Sounds/Elemental/Fireball2.wav')
        }
